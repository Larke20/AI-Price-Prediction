...
class IndicatorBacktest:
    ...
    def plot_bollinger_bands(self):
        ...
        self.finalize_plot(
            fig, f"Bollinger Bands with Buy/Sell Signals Final Capital = ${format(round(self.capital, 2), ',')}")
        
        
        html = fig.to_html(full_html=False, include_plotlyjs='cdn')
        self.reset_state()
        file_path = os.path.join(
            '/Users/landonclarke/VS_Code/csc3380-fall-2023-project-group-3/data/', 'bollinger_bands.html')
    ...
    def plot_dual_thrust(self):
        ...
        self.finalize_plot(
            fig, f"Dual Thrust with Buy/Sell Signals Final Capital = ${format(round(self.capital, 2), ',')}")
        html = fig.to_html(full_html=False, include_plotlyjs='cdn')
        self.reset_state()
        file_path = os.path.join(
            '/Users/landonclarke/VS_Code/csc3380-fall-2023-project-group-3/data/', 'dual_thrust.html')
        with open(file_path, 'w') as file:
            file.write(html)
        return html
    ...
    def plot_heikin_ashi(self):
        ...
        self.finalize_plot(
            fig, f"Heikin-Ashi with Buy/Sell Signals Final Capital = ${format(round(self.capital, 2), ',')}")
        html = fig.to_html(full_html=False, include_plotlyjs='cdn')
        self.reset_state()
        file_path = os.path.join(
            '/Users/landonclarke/VS_Code/csc3380-fall-2023-project-group-3/data/', 'heikin_ashi.html')
        with open(file_path, 'w') as file:
            file.write(html)
        return html
    ...
    def plot_awesome(self):
        ...
        self.finalize_plot(
            fig, f"Awesome Oscillator with Buy/Sell Signals Final Capital = ${format(round(self.capital, 2), ',')}")
        html = fig.to_html(full_html=False, include_plotlyjs='cdn')
        self.reset_state()
        file_path = os.path.join(
            '/Users/landonclarke/VS_Code/csc3380-fall-2023-project-group-3/data/', 'awesome.html')
        with open(file_path, 'w') as file:
            file.write(html)
        return html
    ...
    def plot_macd(self):
        ...
        self.finalize_plot(
            fig, f"MACD with Buy/Sell Signals Final Capital = ${format(round(self.capital, 2), ',')}")
        html = fig.to_html(full_html=False, include_plotlyjs='cdn')
        self.reset_state()
        file_path = os.path.join(
            '/Users/landonclarke/VS_Code/csc3380-fall-2023-project-group-3/data/', 'macd.html')
        with open(file_path, 'w') as file:
            file.write(html)
    ...
    def plot_sar(self):
        ...
        self.finalize_plot(
            fig, f"Parabolic SAR with Buy/Sell Signals Final Capital = ${format(round(self.capital, 2), ',')}")
        html = fig.to_html(full_html=False, include_plotlyjs='cdn')
        self.reset_state()
        file_path = os.path.join(
            '/Users/landonclarke/VS_Code/csc3380-fall-2023-project-group-3/data/', 'parabolic_sar.html')
        with open(file_path, 'w') as file:
            file.write(html)
    ...
    def plot_rsi(self):
        ...
        self.finalize_plot(
            fig, f"RSI with Buy/Sell Signals Final Capital = ${format(round(self.capital, 2), ',')}")
        html = fig.to_html(full_html=False, include_plotlyjs='cdn')
        self.reset_state()
        # Save HTML to a file
        file_path = os.path.join('/Users/landonclarke/VS_Code/csc3380-fall-2023-project-group-3/data/', 'rsi.html')
        with open(file_path, 'w') as file:
            file.write(html)
        return html
