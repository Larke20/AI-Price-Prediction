...
class IndicatorBacktest:
    ...
    def plot_bollinger_bands(self):
        ...
        file_path = os.path.join(
            '/Users/landonclarke/VS_Code/AI-Price-Prediction/data/', 'bollinger_bands.html')
    ...
    def plot_dual_thrust(self):
        ...
        self.reset_state()
        file_path = os.path.join(
            '/Users/landonclarke/VS_Code/AI-Price-Prediction/data/', 'dual_thrust.html')
        with open(file_path, 'w') as file:
            file.write(html)
        return html
    ...
    def plot_heikin_ashi(self):
        ...
        self.reset_state()
        file_path = os.path.join(
            '/Users/landonclarke/VS_Code/AI-Price-Prediction/data/', 'heikin_ashi.html')
        with open(file_path, 'w') as file:
            file.write(html)
        return html
    ...
    def plot_awesome(self):
        ...
        self.reset_state()
        file_path = os.path.join(
            '/Users/landonclarke/VS_Code/AI-Price-Prediction/data/', 'awesome.html')
        with open(file_path, 'w') as file:
            file.write(html)
        return html
    ...
    def plot_macd(self):
        ...
        self.reset_state()
        file_path = os.path.join(
            '/Users/landonclarke/VS_Code/AI-Price-Prediction/data/', 'macd.html')
        with open(file_path, 'w') as file:
            file.write(html)
    ...
    def plot_sar(self):
        ...
        self.reset_state()
        file_path = os.path.join(
            '/Users/landonclarke/VS_Code/AI-Price-Prediction/data/', 'parabolic_sar.html')
        with open(file_path, 'w') as file:
            file.write(html)
    ...
    def plot_rsi(self):
        ...
        self.reset_state()
        # Save HTML to a file
        file_path = os.path.join('/Users/landonclarke/VS_Code/AI-Price-Prediction/data/', 'rsi.html')
        with open(file_path, 'w') as file:
            file.write(html)
        return html
