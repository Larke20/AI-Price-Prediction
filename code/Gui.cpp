...
void Gui::onButtonClicked() {
    ...
    QString pythonPath = QString::fromStdString(user_path + "AI-Price-Prediction/env/bin/python");
    QString runPyPath = QString::fromStdString(user_path + "AI-Price-Prediction/code/run_py.py");
    ...
    DataFrame df(user_path + "AI-Price-Prediction/data/" + ticker.toStdString() + ".csv");
    ...
    //df.print_tail(10);
    df.save_to_csv(user_path + "AI-Price-Prediction/data/processed_" + ticker.toStdString() + ".csv", false);
    //cout << endl;
    

    runPythonScript(pythonPath, runPyPath, QStringList() << "modeling.py" << ticker << "3" << "5" << "10");
    ...
    //og_df.print_tail(10);
    og_df.drop_na();
    og_df.save_to_csv(user_path + "AI-Price-Prediction/data/" + ticker.toStdString() + "_indicators.csv", true);
    
    
    std::string csvFilename = user_path + "AI-Price-Prediction/data/" + ticker.toStdString() + "_indicators.csv";
...
void Gui::displayHtmlContent(int index) {
    ...
    QFile file(QString::fromStdString(user_path + "AI-Price-Prediction/data/" + htmls[index]));
...
void Gui::runPythonScript(const QString &pythonPath, const QString &runPyPath, const QStringList &arguments) {
    ...
    bool finished = process.waitForFinished(120000 * 2); // Wait for 2 minutes
